...
TVM_DLL std::vector<int64_t> SamplePerfectTile2(
    support::LinearCongruentialEngine::TRandState* rand_state,  //
    int32_t extent, int32_t n_split, int32_t min_n_splits, int32_t max_n_splits);
/*!
 * \brief Sample the factors to perfect tile a specific loop
 * \param rand_state The random state
...
TVM_DLL std::vector<int64_t> SamplePerfectTile2(
    support::LinearCongruentialEngine::TRandState* rand_state,  //
    const tir::StmtSRef& loop_sref, int32_t n_split, int32_t min_n_splits, int32_t max_n_splits,
