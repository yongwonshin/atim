...
#ifndef TVM_INFO_USE_UPMEM
#define TVM_INFO_USE_UPMEM "NOT-FOUND"
#endif

#ifndef TVM_INFO_USE_HBMPIM
#define TVM_INFO_USE_HBMPIM "NOT_FOUND"
#endif
...
TVM_DLL Map<String, String> GetLibInfo() {
  Map<String, String> result = {
      ...
      {"USE_UPMEM", TVM_INFO_USE_UPMEM},
      {"USE_HBMPIM", TVM_INFO_USE_HBMPIM},
