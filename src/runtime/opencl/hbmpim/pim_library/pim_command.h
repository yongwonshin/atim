...
#ifndef TVM_RUNTIME_OPENCL_HBMPIM_PIM_COMMAND_H_
#define TVM_RUNTIME_OPENCL_HBMPIM_PIM_COMMAND_H_
...
class PimCommand {
 public:
  ...
  PimCommand(PimCmdType type, PimOpdType dst, PimOpdType src0, int is_auto = 0, int dst_idx = 0,
  ...
  PimCommand(PimCmdType type, PimOpdType dst, PimOpdType src0, PimOpdType src1, int is_auto = 0,
  ...
  PimCommand(PimCmdType type, PimOpdType dst, PimOpdType src0, PimOpdType src1, PimOpdType src2,
  ...
  uint32_t to_bit(uint32_t val, int bit_len, int bit_pos) const {
    return ((val & bitmask(bit_len)) << bit_pos);
  }
  uint32_t from_bit(uint32_t val, int bit_len, int bit_pos) const {
...
#endif  // TVM_RUNTIME_OPENCL_HBMPIM_PIM_COMMAND_H_
