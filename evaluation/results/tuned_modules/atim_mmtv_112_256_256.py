...
@I.ir_module
class module_atim_mmtv_112_256_256:
    @T.prim_func
    def main(A: T.Buffer((112, 256, 256), "int32"), B: T.Buffer((112, 256), "int32"), C: T.Buffer((112, 256), "int32")):
        ...
        with T.block("root"):
            ...
            C_rf_global = T.alloc_buffer((112, 2, 256), "int32")
            C_rf_global_local = T.alloc_buffer((112, 2, 256), "int32", scope="local")
            A_local = T.alloc_buffer((112, 256, 256), "int32", scope="local")
            ...
            for k_0 in T.thread_binding(2, thread="blockIdx.x", annotations={"bank": T.int64(1)}):
                for i_0 in T.thread_binding(112, thread="blockIdx.y", annotations={"bank": T.int64(1)}):
                    for j_0 in T.thread_binding(8, thread="blockIdx.z", annotations={"bank": T.int64(1)}):
                            ...
                            for i_1, i_2, j_2 in T.grid(1, 1, 1):
                                for i_3_init, j_3_init, i_4_init, j_4_init in T.grid(1, 2, 1, 1):
                                    with T.block("C_rf_init"):
                                        ...
                                        v_j = T.axis.spatial(256, j_0 * 32 + j_1 * 2 + j_2 * 2 + j_3_init + j_4_init)
                                ...
                                for k_1_0 in range(2):
                                    for ax0, ax1, ax2 in T.grid(1, 2, 64):
                                        with T.block("A_local"):
                                            ...
                                            v2 = T.axis.spatial(256, k_0 * 128 + k_1_0 * 64 + ax2)
                                            T.reads(A[v0, v1, v2])
                                    ...
                                    for ax0, ax1 in T.grid(1, 64):
                                        with T.block("B_local"):
                                            v0 = T.axis.spatial(112, i_0 + ax0)
                                            v1 = T.axis.spatial(256, k_0 * 128 + k_1_0 * 64 + ax1)
                                            T.reads(B[v0, v1])
                                            T.writes(B_local[v0, v1])
                                            T.block_attr({"meta_schedule.cooperative_fetch": 1})
                                            B_local[v0, v1] = B[v0, v1]
                                    for i_3, j_3, k_1_1, i_4, j_4, k_1_2 in T.grid(1, 2, 8, 1, 1, 8):
                                        with T.block("C_rf_update"):
                                            v_i = T.axis.spatial(112, i_0 + i_1 + i_2 + i_3 + i_4)
                                            v_j = T.axis.spatial(256, j_0 * 32 + j_1 * 2 + j_2 * 2 + j_3 + j_4)
                                            vk_0 = T.axis.spatial(2, k_0)
                                            vk_1 = T.axis.reduce(128, k_1_0 * 64 + k_1_1 * 8 + k_1_2)
                                            T.reads(C_rf_global_local[v_i, vk_0, v_j], A_local[v_i, v_j, vk_0 * 128 + vk_1], B_local[v_i, vk_0 * 128 + vk_1])
                                            T.writes(C_rf_global_local[v_i, vk_0, v_j])
                                            T.block_attr({"meta_schedule.meta_schedule_rfactor_producer_block": T.int64(1), "meta_schedule.tiling_structure": "SSSRSRSR"})
                                            C_rf_global_local[v_i, vk_0, v_j] = C_rf_global_local[v_i, vk_0, v_j] + A_local[v_i, v_j, vk_0 * 128 + vk_1] * B_local[v_i, vk_0 * 128 + vk_1]
                                for ax0, ax1, ax2 in T.grid(1, 1, 2):
                                    with T.block("C_rf_global_local"):
                                        v0 = T.axis.spatial(112, i_0 + ax0)
                                        v1 = T.axis.spatial(2, k_0 + ax1)
                                        v2 = T.axis.spatial(256, j_0 * 32 + j_1 * 2 + ax2)
                                        T.reads(C_rf_global_local[v0, v1, v2])
                                        T.writes(C_rf_global[v0, v1, v2])
                                        C_rf_global[v0, v1, v2] = C_rf_global_local[v0, v1, v2]
            for i, j in T.grid(112, 256):
                with T.block("C_init"):
...
# from tvm import tir
def apply_trace_atim_mmtv_112_256_256(sch: tir.Schedule) -> None:
  b0 = sch.get_block(name="C", func_name="main")
  b1 = sch.get_block(name="root", func_name="main")
  l2, l3, l4 = sch.get_loops(block=b0)
  v5, v6 = sch.sample_perfect_tile2(loop=l4, n=2, min_n_splits=2, max_n_splits=256, decision=[2, 128])
  ...
  v25, v26, v27, v28, v29 = sch.sample_perfect_tile(loop=l12, n=5, max_innermost_factor=256, min_innermost_factor=1, decision=[8, 16, 1, 2, 1])
  l30, l31, l32, l33, l34 = sch.split(loop=l12, factors=[v25, v26, v27, v28, v29], preserve_unit_iters=True)
  v35, v36, v37 = sch.sample_perfect_tile(loop=l14, n=3, max_innermost_factor=256, min_innermost_factor=1, decision=[2, 8, 8])
