...
@I.ir_module
class module_atim_mmtv_64_512_256:
    @T.prim_func
    def main(A: T.Buffer((64, 512, 256), "int32"), B: T.Buffer((64, 256), "int32"), C: T.Buffer((64, 512), "int32")):
        ...
        with T.block("root"):
            ...
            C_rf_global = T.alloc_buffer((64, 4, 512), "int32")
            C_rf_global_local = T.alloc_buffer((64, 4, 512), "int32", scope="local")
            A_local = T.alloc_buffer((64, 512, 256), "int32", scope="local")
            B_local = T.alloc_buffer((64, 256), "int32", scope="local")
            for k_0 in T.thread_binding(4, thread="blockIdx.x", annotations={"bank": T.int64(1)}):
                for i_0 in T.thread_binding(64, thread="blockIdx.y", annotations={"bank": T.int64(1)}):
                    for j_0 in T.thread_binding(4, thread="blockIdx.z", annotations={"bank": T.int64(1)}):
                            ...
                            for i_1, i_2, j_2 in T.grid(1, 1, 1):
                                for i_3_init, j_3_init, i_4_init, j_4_init in T.grid(1, 8, 1, 1):
                                    with T.block("C_rf_init"):
                                        ...
                                        v_j = T.axis.spatial(512, j_0 * 128 + j_1 * 8 + j_2 * 8 + j_3_init + j_4_init)
                                ...
                                for k_1_0, i_3, j_3, k_1_1 in T.grid(8, 1, 8, 1):
                                    for ax0, ax1, ax2 in T.grid(1, 1, 8):
                                        with T.block("A_local"):
                                            v0 = T.axis.spatial(64, i_0 + ax0)
                                            v1 = T.axis.spatial(512, j_0 * 128 + j_1 * 8 + j_3 + ax1)
                                            v2 = T.axis.spatial(256, k_0 * 64 + k_1_0 * 8 + ax2)
                                            T.reads(A[v0, v1, v2])
                                    ...
                                    for ax0, ax1 in T.grid(1, 8):
                                        with T.block("B_local"):
                                            v0 = T.axis.spatial(64, i_0 + ax0)
                                            v1 = T.axis.spatial(256, k_0 * 64 + k_1_0 * 8 + ax1)
                                            T.reads(B[v0, v1])
                                            T.writes(B_local[v0, v1])
                                            T.block_attr({"meta_schedule.cooperative_fetch": 1})
                                            B_local[v0, v1] = B[v0, v1]
                                    for i_4, j_4, k_1_2 in T.grid(1, 1, 8):
                                        with T.block("C_rf_update"):
                                            v_i = T.axis.spatial(64, i_0 + i_1 + i_2 + i_3 + i_4)
                                            v_j = T.axis.spatial(512, j_0 * 128 + j_1 * 8 + j_2 * 8 + j_3 + j_4)
                                            vk_0 = T.axis.spatial(4, k_0)
                                            vk_1 = T.axis.reduce(64, k_1_0 * 8 + k_1_1 * 8 + k_1_2)
...
# from tvm import tir
def apply_trace_atim_mmtv_64_512_256(sch: tir.Schedule) -> None:
  ...
  v25, v26, v27, v28, v29 = sch.sample_perfect_tile(loop=l12, n=5, max_innermost_factor=256, min_innermost_factor=1, decision=[4, 16, 1, 8, 1])
  l30, l31, l32, l33, l34 = sch.split(loop=l12, factors=[v25, v26, v27, v28, v29], preserve_unit_iters=True)
  v35, v36, v37 = sch.sample_perfect_tile(loop=l14, n=3, max_innermost_factor=256, min_innermost_factor=1, decision=[8, 1, 8])
  ...
  l81, l82, l83, l84, l85, l86, l87, l88, l89, l90, l91, l92, l93, l94 = sch.get_loops(block=b51)
