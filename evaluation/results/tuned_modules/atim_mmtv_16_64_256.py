...
@I.ir_module
class module_atim_mmtv_16_64_256:
    @T.prim_func
    def main(A: T.Buffer((16, 64, 256), "int32"), B: T.Buffer((16, 256), "int32"), C: T.Buffer((16, 64), "int32")):
        ...
        with T.block("root"):
            ...
            C_rf_global = T.alloc_buffer((16, 8, 64), "int32")
            C_rf_global_local = T.alloc_buffer((16, 8, 64), "int32", scope="local")
...
# from tvm import tir
def apply_trace_atim_mmtv_16_64_256(sch: tir.Schedule) -> None:
  ...
  v35, v36, v37 = sch.sample_perfect_tile(loop=l14, n=3, max_innermost_factor=256, min_innermost_factor=1, decision=[2, 4, 4])
