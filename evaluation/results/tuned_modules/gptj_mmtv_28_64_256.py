...
@I.ir_module
class module_gptj_mmtv_28_64_256:
    @T.prim_func
    def main(A: T.Buffer((28, 64, 256), "int32"), B: T.Buffer((28, 256), "int32"), C: T.Buffer((28, 64), "int32")):
        ...
        with T.block("root"):
            ...
            C_rf_global = T.alloc_buffer((28, 4, 64), "int32")
            C_rf_global_local = T.alloc_buffer((28, 4, 64), "int32", scope="local")
            A_local = T.alloc_buffer((28, 64, 256), "int32", scope="local")
                                ...
                                for k_1_0, i_3, j_3, k_1_1 in T.grid(1, 1, 1, 4):
                                    ...
                                    for ax0, ax1 in T.grid(1, 16):
                                        with T.block("B_local"):
                                            v0 = T.axis.spatial(28, i_0 + ax0)
                                            v1 = T.axis.spatial(256, k_0 * 64 + k_1_1 * 16 + ax1)
                                            T.reads(B[v0, v1])
                                    ...
                                    for i_4, j_4, k_1_2 in T.grid(1, 2, 16):
                                        with T.block("C_rf_update"):
                                            ...
                                            vk_0 = T.axis.spatial(4, k_0)
                                            vk_1 = T.axis.reduce(64, k_1_0 * 64 + k_1_1 * 16 + k_1_2)
...
# from tvm import tir
def apply_trace_gptj_mmtv_28_64_256(sch: tir.Schedule) -> None:
  ...
  v35, v36, v37 = sch.sample_perfect_tile(loop=l14, n=3, max_innermost_factor=256, min_innermost_factor=1, decision=[1, 4, 16])
