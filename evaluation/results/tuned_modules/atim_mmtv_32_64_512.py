...
@I.ir_module
class module_atim_mmtv_32_64_512:
    @T.prim_func
...
# from tvm import tir
def apply_trace_atim_mmtv_32_64_512(sch: tir.Schedule) -> None:
  ...
  v25, v26, v27, v28, v29 = sch.sample_perfect_tile(loop=l12, n=5, max_innermost_factor=256, min_innermost_factor=1, decision=[1, 16, 1, 1, 4])
  l30, l31, l32, l33, l34 = sch.split(loop=l12, factors=[v25, v26, v27, v28, v29], preserve_unit_iters=True)
  v35, v36, v37 = sch.sample_perfect_tile(loop=l14, n=3, max_innermost_factor=256, min_innermost_factor=1, decision=[2, 4, 8])
  ...
  sch.annotate(block_or_loop=l54, ann_key="pragma_auto_unroll_max_step", ann_val=64)
