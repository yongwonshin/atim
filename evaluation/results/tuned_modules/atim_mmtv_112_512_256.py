...
@I.ir_module
class module_atim_mmtv_112_512_256:
    @T.prim_func
                        ...
                        for i_1, i_2, j_2 in T.grid(1, 1, 1):
                            for i_3_init, j_3_init, i_4_init, j_4_init in T.grid(1, 1, 1, 2):
                                with T.block("C_init"):
                                    ...
                                    v_j = T.axis.spatial(512, j_0 * 32 + j_1 * 2 + j_2 * 2 + j_3_init * 2 + j_4_init)
                                    T.reads()
...
# from tvm import tir
def apply_trace_atim_mmtv_112_512_256(sch: tir.Schedule) -> None:
