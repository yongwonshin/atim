...
@I.ir_module
class module_poly_mtv_4096_1_4096:
    @T.prim_func
...
# from tvm import tir
def apply_trace_poly_mtv_4096_1_4096(sch: tir.Schedule) -> None:
  ...
  v13, v14, v15, v16, v17 = sch.sample_perfect_tile(loop=l10, n=5, max_innermost_factor=256, min_innermost_factor=1, decision=[64, 8, 1, 2, 4])
  l18, l19, l20, l21, l22 = sch.split(loop=l10, factors=[v13, v14, v15, v16, v17], preserve_unit_iters=True)
  v23, v24, v25 = sch.sample_perfect_tile(loop=l12, n=3, max_innermost_factor=256, min_innermost_factor=1, decision=[2, 4, 16])
