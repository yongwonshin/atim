...
@I.ir_module
class module_atim_mmtv_256_64_256:
    @T.prim_func
    def main(A: T.Buffer((256, 64, 256), "int32"), B: T.Buffer((256, 256), "int32"), C: T.Buffer((256, 64), "int32")):
        ...
        with T.block("root"):
            ...
            C_local = T.alloc_buffer((256, 64), "int32", scope="local")
                        ...
                        for i_1, i_2, j_2 in T.grid(1, 1, 1):
                            for i_3_init, j_3_init, i_4_init, j_4_init in T.grid(1, 2, 1, 1):
                                with T.block("C_init"):
                                    ...
                                    v_j = T.axis.spatial(64, j_0 * 16 + j_1 * 2 + j_2 * 2 + j_3_init + j_4_init)
                                    T.reads()
                            ...
                            for k_0 in range(8):
                                ...
                                for i_3, j_3, k_1, i_4, j_4, k_2 in T.grid(1, 2, 2, 1, 1, 16):
                                    with T.block("C_update"):
                                        v_i = T.axis.spatial(256, i_0 + i_1 + i_2 + i_3 + i_4)
                                        v_j = T.axis.spatial(64, j_0 * 16 + j_1 * 2 + j_2 * 2 + j_3 + j_4)
...
# from tvm import tir
def apply_trace_atim_mmtv_256_64_256(sch: tir.Schedule) -> None:
  ...
  v15, v16, v17, v18, v19 = sch.sample_perfect_tile(loop=l3, n=5, max_innermost_factor=256, min_innermost_factor=1, decision=[4, 8, 1, 2, 1])
