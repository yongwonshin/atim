...
@I.ir_module
class module_atim_mmtv_448_128_256:
    @T.prim_func
    def main(A: T.Buffer((448, 128, 256), "int32"), B: T.Buffer((448, 256), "int32"), C: T.Buffer((448, 128), "int32")):
        ...
        with T.block("root"):
            ...
            C_local = T.alloc_buffer((448, 128), "int32", scope="local")
            A_local = T.alloc_buffer((448, 128, 256), "int32", scope="local")
                            ...
                            for k_0, i_3, j_3, k_1 in T.grid(8, 1, 1, 2):
                                ...
                                for ax0, ax1 in T.grid(1, 16):
                                    with T.block("B_local"):
                                        v0 = T.axis.spatial(448, i_0 + ax0)
                                        v1 = T.axis.spatial(256, k_0 * 32 + k_1 * 16 + ax1)
                                        T.reads(B[v0, v1])
                                ...
                                for i_4, j_4, k_2 in T.grid(1, 2, 16):
                                    with T.block("C_update"):
                                        ...
                                        v_j = T.axis.spatial(128, j_0 * 32 + j_1 * 2 + j_2 * 2 + j_3 * 2 + j_4)
                                        v_k = T.axis.reduce(256, k_0 * 32 + k_1 * 16 + k_2)
...
# from tvm import tir
def apply_trace_atim_mmtv_448_128_256(sch: tir.Schedule) -> None:
  ...
  v15, v16, v17, v18, v19 = sch.sample_perfect_tile(loop=l3, n=5, max_innermost_factor=256, min_innermost_factor=1, decision=[4, 16, 1, 1, 2])
  l20, l21, l22, l23, l24 = sch.split(loop=l3, factors=[v15, v16, v17, v18, v19], preserve_unit_iters=True)
  v25, v26, v27 = sch.sample_perfect_tile(loop=l4, n=3, max_innermost_factor=256, min_innermost_factor=1, decision=[8, 2, 16])
