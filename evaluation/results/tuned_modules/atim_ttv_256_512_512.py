...
@I.ir_module
class module_atim_ttv_256_512_512:
    @T.prim_func
...
# from tvm import tir
def apply_trace_atim_ttv_256_512_512(sch: tir.Schedule) -> None:
  ...
  v15, v16, v17, v18, v19 = sch.sample_perfect_tile(loop=l3, n=5, max_innermost_factor=256, min_innermost_factor=1, decision=[8, 16, 1, 4, 1])
  l20, l21, l22, l23, l24 = sch.split(loop=l3, factors=[v15, v16, v17, v18, v19], preserve_unit_iters=True)
  v25, v26, v27 = sch.sample_perfect_tile(loop=l4, n=3, max_innermost_factor=256, min_innermost_factor=1, decision=[32, 8, 2])
  ...
  l53, l54, l55, l56, l57, l58, l59, l60 = sch.get_loops(block=b40)
  ...
  l61, l62, l63, l64, l65, l66, l67, l68, l69, l70, l71, l72, l73 = sch.get_loops(block=b41)
  sch.annotate(block_or_loop=l61, ann_key="pragma_auto_unroll_max_step", ann_val=512)
  sch.annotate(block_or_loop=l61, ann_key="pragma_unroll_explicit", ann_val=0)
  l74, l75, l76, l77, l78, l79, l80, l81, l82, l83, l84 = sch.get_loops(block=b42)
  ...
  l86, l87, l88, l89, l90, l91, l92, l93, l94, l95, l96, l97, l98 = sch.get_loops(block=b85)
  b99 = sch.decompose_reduction(block=b85, loop=l92)
