...
@I.ir_module
class module_gptj_red_524288_1_1:
    @T.prim_func
...
# from tvm import tir
def apply_trace_gptj_red_524288_1_1(sch: tir.Schedule) -> None:
  b0 = sch.get_block(name="C", func_name="main")
  b1 = sch.get_block(name="root", func_name="main")
  l2, = sch.get_loops(block=b0)
  v3, v4 = sch.sample_perfect_tile2(loop=l2, n=2, min_n_splits=2, max_n_splits=2048, decision=[128, 4096])
  ...
  v11, v12 = sch.sample_perfect_tile2(loop=l10, n=2, min_n_splits=2, max_n_splits=24, decision=[8, 512])
  ...
  v23, v24, v25 = sch.sample_perfect_tile(loop=l22, n=3, max_innermost_factor=256, min_innermost_factor=1, decision=[8, 2, 32])
  ...
  v37 = sch.sample_categorical(candidates=[0, 16, 64, 512], probs=[0.25, 0.25, 0.25, 0.25], decision=0)
