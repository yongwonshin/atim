...
@I.ir_module
class module_atim_mmtv_448_64_256:
    @T.prim_func
    def main(A: T.Buffer((448, 64, 256), "int32"), B: T.Buffer((448, 256), "int32"), C: T.Buffer((448, 64), "int32")):
        ...
        with T.block("root"):
            ...
            C_local = T.alloc_buffer((448, 64), "int32", scope="local")
            A_local = T.alloc_buffer((448, 64, 256), "int32", scope="local")
            B_local = T.alloc_buffer((448, 256), "int32", scope="local")
            for i_0 in T.thread_binding(448, thread="blockIdx.x", annotations={"bank": T.int64(1), "pragma_auto_unroll_max_step": T.int64(64), "pragma_unroll_explicit": T.int64(0)}):
                        ...
                        for i_1, i_2, j_2 in T.grid(1, 1, 1):
                            ...
                            for k_0, i_3, j_3 in T.grid(8, 1, 1):
                                for k_1 in range(1):
                                    ...
                                    for i_4, j_4, k_2 in T.grid(1, 2, 32):
                                        with T.block("C_update"):
                                            v_i = T.axis.spatial(448, i_0 + i_1 + i_2 + i_3 + i_4)
                                            v_j = T.axis.spatial(64, j_0 * 16 + j_1 * 2 + j_2 * 2 + j_3 * 2 + j_4)
...
# from tvm import tir
def apply_trace_atim_mmtv_448_64_256(sch: tir.Schedule) -> None:
  ...
  v15, v16, v17, v18, v19 = sch.sample_perfect_tile(loop=l3, n=5, max_innermost_factor=256, min_innermost_factor=1, decision=[4, 8, 1, 1, 2])
