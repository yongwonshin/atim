...
@I.ir_module
class module_poly_mtv_8192_1_8192:
    @T.prim_func
...
# from tvm import tir
def apply_trace_poly_mtv_8192_1_8192(sch: tir.Schedule) -> None:
  b0 = sch.get_block(name="C", func_name="main")
  b1 = sch.get_block(name="root", func_name="main")
  l2, l3 = sch.get_loops(block=b0)
  v4, v5 = sch.sample_perfect_tile2(loop=l3, n=2, min_n_splits=2, max_n_splits=256, decision=[32, 256])
  ...
  v13, v14, v15, v16, v17 = sch.sample_perfect_tile(loop=l10, n=5, max_innermost_factor=256, min_innermost_factor=1, decision=[64, 16, 2, 4, 1])
  l18, l19, l20, l21, l22 = sch.split(loop=l10, factors=[v13, v14, v15, v16, v17], preserve_unit_iters=True)
  v23, v24, v25 = sch.sample_perfect_tile(loop=l12, n=3, max_innermost_factor=256, min_innermost_factor=1, decision=[8, 2, 16])
  ...
  sch.annotate(block_or_loop=l55, ann_key="pragma_auto_unroll_max_step", ann_val=16)
  ...
  sch.annotate(block_or_loop=l72, ann_key="pragma_auto_unroll_max_step", ann_val=16)
