...
@I.ir_module
class module_gptj_mmtv_28_512_256:
    @T.prim_func
    def main(A: T.Buffer((28, 512, 256), "int32"), B: T.Buffer((28, 256), "int32"), C: T.Buffer((28, 512), "int32")):
        ...
        with T.block("root"):
            ...
            C_rf_global = T.alloc_buffer((28, 8, 512), "int32")
            C_rf_global_local = T.alloc_buffer((28, 8, 512), "int32", scope="local")
            A_local = T.alloc_buffer((28, 512, 256), "int32", scope="local")
                            ...
                            for i_1, i_2, j_2 in T.grid(1, 1, 4):
                                for i_3_init, j_3_init, i_4_init, j_4_init in T.grid(1, 1, 1, 2):
                                    with T.block("C_rf_init"):
                                        ...
                                        v_j = T.axis.spatial(512, j_0 * 128 + j_1 * 8 + j_2 * 2 + j_3_init * 2 + j_4_init)
                                ...
                                for k_1_0, i_3, j_3 in T.grid(4, 1, 1):
                                    for k_1_1 in range(1):
                                        ...
                                        for i_4, j_4, k_1_2 in T.grid(1, 2, 8):
                                            with T.block("C_rf_update"):
                                                v_i = T.axis.spatial(28, i_0 + i_1 + i_2 + i_3 + i_4)
                                                v_j = T.axis.spatial(512, j_0 * 128 + j_1 * 8 + j_2 * 2 + j_3 * 2 + j_4)
                                                vk_0 = T.axis.spatial(8, k_0)
                                                vk_1 = T.axis.reduce(32, k_1_0 * 8 + k_1_1 * 8 + k_1_2)
...
# from tvm import tir
def apply_trace_gptj_mmtv_28_512_256(sch: tir.Schedule) -> None:
  ...
  v25, v26, v27, v28, v29 = sch.sample_perfect_tile(loop=l12, n=5, max_innermost_factor=256, min_innermost_factor=1, decision=[4, 16, 4, 1, 2])
  l30, l31, l32, l33, l34 = sch.split(loop=l12, factors=[v25, v26, v27, v28, v29], preserve_unit_iters=True)
  v35, v36, v37 = sch.sample_perfect_tile(loop=l14, n=3, max_innermost_factor=256, min_innermost_factor=1, decision=[4, 1, 8])
  ...
  l95, l96, l97, l98, l99, l100, l101, l102, l103, l104, l105, l106, l107 = sch.get_loops(block=b52)
  l108, l109, l110 = sch.get_loops(block=b53)
  b111 = sch.get_block(name="C_rf", func_name="main")
  l112, l113, l114, l115, l116, l117, l118, l119, l120, l121, l122, l123, l124, l125 = sch.get_loops(block=b111)
