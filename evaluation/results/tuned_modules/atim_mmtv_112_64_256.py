...
class module_atim_mmtv_112_64_256:
    ...
    def main(A: T.Buffer((112, 64, 256), "int32"), B: T.Buffer((112, 256), "int32"), C: T.Buffer((112, 64), "int32")):
        ...
        with T.block("root"):
            ...
            C_local = T.alloc_buffer((112, 64), "int32", scope="local")
            A_local = T.alloc_buffer((112, 64, 256), "int32", scope="local")
            B_local = T.alloc_buffer((112, 256), "int32", scope="local")
            for i_0 in T.thread_binding(112, thread="blockIdx.x", annotations={"bank": T.int64(1)}):
                for j_0 in T.thread_binding(2, thread="blockIdx.y", annotations={"bank": T.int64(1)}):
                        ...
                        for i_1, i_2, j_2 in T.grid(1, 1, 1):
                            for i_3_init, j_3_init, i_4_init, j_4_init in T.grid(1, 1, 1, 2):
                                with T.block("C_init"):
                                    ...
                                    C_local[v_i, v_j] = 0
                            for k_0, i_3, j_3, k_1 in T.grid(16, 1, 1, 1):
...
def apply_trace_atim_mmtv_112_64_256(sch: tir.Schedule) -> None:
  ...
  v15, v16, v17, v18, v19 = sch.sample_perfect_tile(loop=l3, n=5, max_innermost_factor=256, min_innermost_factor=1, decision=[2, 16, 1, 1, 2])
