...
@I.ir_module
class module_cpu_mmtv_128_256_512:
    @T.prim_func
        ...
        for i_0_j_0_i_1_j_1_fused_fused in T.parallel(4096):
            for i_2_init, j_2_init, i_3_init in T.grid(1, 4, 1):
                for j_3_fused_init in T.vectorized(2):
                    with T.block("C_init"):
                        v_i = T.axis.spatial(128, i_0_j_0_i_1_j_1_fused_fused // 64 * 2 + i_0_j_0_i_1_j_1_fused_fused % 16 // 8 + i_2_init + i_3_init)
                        ...
                        C_global[v_i, v_j] = 0
            for k_0, i_2, j_2, k_1, i_3 in T.grid(256, 1, 4, 2, 1):
                for j_3_fused in T.vectorized(2):
                    with T.block("C_update"):
                        v_i = T.axis.spatial(128, i_0_j_0_i_1_j_1_fused_fused // 64 * 2 + i_0_j_0_i_1_j_1_fused_fused % 16 // 8 + i_2 + i_3)
            ...
            for ax0 in range(1):
                for ax1_fused in T.vectorized(8):
                    with T.block("C_global"):
                        v0 = T.axis.spatial(128, i_0_j_0_i_1_j_1_fused_fused // 64 * 2 + i_0_j_0_i_1_j_1_fused_fused % 16 // 8 + ax0)
...
# from tvm import tir
def apply_trace_cpu_mmtv_128_256_512(sch: tir.Schedule) -> None:
