...
@I.ir_module
class module_cpu_mmtv_256_512_256:
    @T.prim_func
    def main(A: T.Buffer((256, 512, 256), "int32"), B: T.Buffer((256, 256), "int32"), C: T.Buffer((256, 512), "int32")):
        T.func_attr({"global_symbol": "main", "pragma_explicit_h2d": ["A"], "tir.noalias": T.bool(True)})
        # with T.block("root"):
        C_global = T.alloc_buffer((256, 512), "int32")
        for i_0_j_0_i_1_j_1_fused in T.parallel(131072, annotations={"pragma_auto_unroll_max_step": T.int64(512), "pragma_unroll_explicit": T.int64(1)}):
            for i_2_init, j_2_init, i_3_init, j_3_init in T.grid(1, 1, 1, 1):
                with T.block("C_init"):
                    v_i = T.axis.spatial(256, i_0_j_0_i_1_j_1_fused // 1024 * 2 + i_0_j_0_i_1_j_1_fused % 512 // 256 + i_2_init + i_3_init)
            ...
            for k_0, i_2, j_2, k_1, i_3, j_3 in T.grid(16, 1, 1, 16, 1, 1):
                with T.block("C_update"):
                    v_i = T.axis.spatial(256, i_0_j_0_i_1_j_1_fused // 1024 * 2 + i_0_j_0_i_1_j_1_fused % 512 // 256 + i_2 + i_3)
            ...
            for ax0, ax1 in T.grid(1, 1):
                with T.block("C_global"):
                    v0 = T.axis.spatial(256, i_0_j_0_i_1_j_1_fused // 1024 * 2 + i_0_j_0_i_1_j_1_fused % 512 // 256 + ax0)
...
# from tvm import tir
def apply_trace_cpu_mmtv_256_512_256(sch: tir.Schedule) -> None:
  b0 = sch.get_block(name="C", func_name="main")
  b1 = sch.get_block(name="root", func_name="main")
  sch.annotate(block_or_loop=b0, ann_key="meta_schedule.tiling_structure", ann_val="SSRSRS")
  l2, l3, l4 = sch.get_loops(block=b0)
  v5, v6, v7, v8 = sch.sample_perfect_tile(loop=l2, n=4, max_innermost_factor=64, decision=[128, 2, 1, 1])
