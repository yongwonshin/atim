...
if(USE_HBMPIM)
  message(STATUS "Build with HBMPIM support")
  include_directories(SYSTEM "3rdparty/hbmpim/external_libs/include")
  include_directories(SYSTEM "3rdparty/hbmpim/external_libs/include/dramsim2")
  include_directories(SYSTEM "3rdparty/hbmpim/external_libs/include/dramsim2/lib")
  # link_directories("3rdparty/hbmpim/external_libs")
  # set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -ldramsim2")
  # set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -ldramsim2")
  tvm_file_glob(GLOB RUNTIME_HBMPIM_SRCS src/runtime/opencl/hbmpim/*.cc)
  tvm_file_glob(GLOB RUNTIME_HBMPIM_LIBRARY_SRCS src/runtime/opencl/hbmpim/pim_library/*.cc)
  list(APPEND RUNTIME_SRCS ${RUNTIME_HBMPIM_SRCS} ${RUNTIME_HBMPIM_LIBRARY_SRCS})
  if(NOT USE_OPENCL)
    message(STATUS "Enable OpenCL support required for HBMPIM")
    set(USE_OPENCL ON)
  endif()
  add_definitions(-DUSE_HBMPIM)
else()
  include_directories(SYSTEM "3rdparty/hbmpim/external_libs/include")
  include_directories(SYSTEM "3rdparty/hbmpim/external_libs/include/dramsim2")
  include_directories(SYSTEM "3rdparty/hbmpim/external_libs/include/dramsim2/lib")
